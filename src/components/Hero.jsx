...
function Hero({ theme }) {
  return (
    <Box
      ...
      p={3}
      sx={{
        [theme.containerQueries.down(1024)]: {
          gridTemplateColumns: "1fr",
        },
        [theme.containerQueries.up(1024)]: {
    ...
    >
      ...
      >
        <Typography
          ...
          fontWeight={700}
          sx={{
            [theme.containerQueries.up(568)]: {
              fontSize: "3.2rem",
            },
            [theme.containerQueries.down(568)]: {
              fontSize: "2.8rem",
            },
            [theme.containerQueries.up(1024)]: {
              fontSize: "4.8rem",
        ...
        <Typography variant="body1" color={grey[500]} fontWeight={600}>
