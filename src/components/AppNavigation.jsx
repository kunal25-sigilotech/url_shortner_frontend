import { Box, Button, Link, Stack, IconButton } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      <Stack
        ...
        sx={{ [theme.containerQueries.down(674)]: { display: "none" } }}
      >
        <Stack
          m={0}
          p={0}
      ...
      <Stack
        ...
        justifySelf="end"
        sx={{
          [theme.containerQueries.down(674)]: { display: "block" },
          [theme.containerQueries.up(674)]: { display: "none" },
        }}
      >
        <IconButton
